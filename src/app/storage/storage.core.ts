...
export class StorageCore {
  ...
  get currentUser(): string {
    return this.getStorageItem(storageKey.user) ?? ErrorEnum.noUser;
  }
  ...
  get accessToken(): string {
    return this.getStorageItem(storageKey.accessToken) ?? ErrorEnum.noAccessToken;
  }
  ...
  get refreshToken(): string {
    return this.getStorageItem(storageKey.refreshToken) ?? ErrorEnum.noRefreshToken;
  }
   ...
   */
  get idToken(): string {
    return this.getStorageItem(storageKey.idToken) ?? ErrorEnum.noIdToken;
  }
